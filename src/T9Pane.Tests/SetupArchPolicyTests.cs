...
public class SetupArchPolicyTests
{
    ...
    public void Amd64_os_installs_both_imes_and_64bit_pane()
    {
        ...
        Assert.True(plan.UseSysnativeForX64Regsvr);
    ...
    [Fact]
    public void Arm64_and_unknown_architectures_are_rejected()
    {
        ...
        Assert.Equal(NativeOsArch.Unsupported, SetupArchPolicy.FromProcessorArchitecture(SetupArchPolicy.ProcessorArm64));
